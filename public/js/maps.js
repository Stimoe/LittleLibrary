...
$(document).ready(function () {
    ...
    function makeSearchMarkers(data) {
        ...
        //         for (let j = 0; j < libraryLocations.length; j++) {
        //             console.log("haha ",libraryLocations[j]);

        //             lat2 = libraryLocations[j].lattitude
        //             long2 = libraryLocations[j].longitude
        //             idOfLibrary = JSON.stringify(libraryLocations[j].id)
        //             // location=data[i].location
        //             markerToMake = {
        //                 lat: lat2,
        //                 lng: long2
    ...
    if (input !== "") {
        ...
        $.get("/api/booksTitle/" + input, function (data) {
            if (data !== null) {
                ...
                console.log("the library of the books from search ", libraryLocations);
